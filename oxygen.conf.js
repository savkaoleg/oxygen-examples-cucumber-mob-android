...
const apkPath = path.resolve(__dirname, './apk/eribank.apk');
...
module.exports = {
    ...
    hooks: {
        ...
        beforeTest: function(runId, options, caps) {
            ...
            global.notEqual = chai.notEqual;
            global.should = chai.should();
            // initialize Oxygen mob module

            // !! add appCaps for local testing
            mob.init(); 
            log.info(apkPath);
            mob.setTimeout(1000);
            global.$ = mob.findElement;
            global.$$ = mob.findElements;
        },
